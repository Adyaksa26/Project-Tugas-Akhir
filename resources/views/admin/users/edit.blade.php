...
@method('PUT')
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="text" name="email" type="text" class="form-control" value="{{$u->email}}">
    </div>
  </div>
  <div class="form-group row">
    <label for="text1" class="col-4 col-form-label">Username</label> 
    <div class="col-8">
      <input id="text1" name="username" type="text" class="form-control" value="{{$u->username}}">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="text1" name="no_hp" type="text" class="form-control" value="{{$u->no_hp}}">
    </div>
  </div>
  <div class="row mb-3">
    <label for="inputPassword3" class="col-sm-2 col-form-label">Foto</label>
    <div class="col-sm-10">
    <input type="file" name="foto" class="form-control" id="inputPassword3" value="{{$u->foto}}">
        @if(!empty($u->foto))
        <img src="{{url('admin/img')}}/{{$u->foto}}" alt="">
            @endif
        </div>
    </div>
  <div class="form-group row">
