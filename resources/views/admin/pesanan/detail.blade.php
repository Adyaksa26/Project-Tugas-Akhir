    ...
    <div class="row">
        <div class="col-md-5">
            ...
            <div class="project-info-box">
                <p><b>User: </b>{{$p->user}}</p>
                <p><b>No Meja: </b>{{$p->no_meja}}</p>
                <p><b>Metode Pembayaran: </b>{{$p->metode_pembayaran}}
                <p><b>Tanggal Pesan: </b>{{$p->tgl_pesan}}</p>
                <p><b>Jam Pesan: </b>{{$p->jam_pesan}}</p>
                <p><b>Menu: </b>{{$p->menu_nama}}</p>
                <p><b>Jenis Pesanan: </b>{{$p->jenis_pesanan_nama}}</p>
            </div>
